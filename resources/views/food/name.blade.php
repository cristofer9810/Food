                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <a href="#" target="_blank" style="display: block; max-width: 128px;">
                              <img src="{{ asset('inicio/img/food logo.png') }}" alt="img" width="150" border="0" style="display: block; width: 200px;" />
                           </a>
                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              ...
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">muy buenas soy,   {{$reserva['name']}} {{$reserva['name_last']}}</span>
                           </font>
                           ...
                           <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 24px; line-height: 32px;">
                            ...
                            <p><strong>Telefono: </strong>{{$reserva['telefono']}}</p>
                              ...
                              <!-- textos -->
                                <br>
                            <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>quiero reservar el dia: </b>{{$reserva['date1']}}
                                <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>a las: </b>{{$reserva['time1']}}
                                    <br>
                           </font>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 50px;">
                                          <img src="{{ asset('inicio/img/food logo.png') }}" alt="img" width="50" border="0" style="display: block; width: 50px;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
                                       ...
                                       <tr>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 19px;">
                                                <img src="{{ asset('inicio/img/soc_1.png') }}" alt="img" width="19" border="0" style="display: block; width: 19px;" />
                                             </a>
                                          </td>
                                          <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">&nbsp;</td>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 18px;">
                                                <img src="{{ asset('inicio/img/soc_2.png') }}" alt="img" width="18" border="0" style="display: block; width: 18px;" />
                                             </a>
                                          </td>
                                          <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">&nbsp;</td>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 21px;">
                                                <img src="{{ asset('inicio/img/soc_3.png') }}" alt="img" width="21" border="0" style="display: block; width: 21px;" />
                                             </a>
                                          </td>
                                          <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">&nbsp;</td>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 25px;">
                                                <img src="{{ asset('inicio/img/soc_4.png') }}" alt="img" width="25" border="0" style="display: block; width: 25px;" />
                                             </a>
                                          </td>
                                       </tr>
                                    </table>
