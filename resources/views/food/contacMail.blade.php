                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              ...
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">muy buenas soy,   {{$contac['name']}}</span>
                           </font>
                           <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                           <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 24px; line-height: 32px;">
                            <p><strong>Correo: </strong>{{$contac['email']}}</p>
                            <p><strong>Telefono: </strong>{{$contac['telefono']}}</p>
                            <p>Mi mensaje es el siguiente: </p>
                              ...
                              <!-- textos -->
                                <br>
                                <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">{{$contac['message']}}
                           </font>
