        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($posts as $post)
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="blog-box-inner">
                            <div class="blog-img-box" style="height: 420px;">
                                @if ($post->image)
                                    <img class="img-fluid" src="{{ Storage::url($post->image->url) }}" >
                                @else
                                    <img class="img-fluid"
                            ...
                            <div class="blog-detail">
                                ...
                                <a class="btn btn-lg btn-circle btn-outline-new-white" href="{{route('food.blog-details', $post)}}">Leer  más</a>
                            </div>
                        </div>
                    </div>
